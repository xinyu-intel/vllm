...
class Qwen3Attention(nn.Module):
    ...
    def forward(
        ...
        attn_output = self._qk_norm_rope(positions, q, k, v)
...
class Qwen3DecoderLayer(nn.Module):
    def __init__(
        ...
        self.sp = parallel_config.use_sequence_parallel if parallel_config else False
        ...
        self._sp_threshold = (
            parallel_config.sequence_parallel_fuse_gemm_threshold
            if parallel_config
            else 0
        )
    ...
    def _attn_fused(
        ...
        attn_output = attn._qk_norm_rope(positions, q, k, v)
...
class Qwen3Model(nn.Module, EagleModelMixin):
